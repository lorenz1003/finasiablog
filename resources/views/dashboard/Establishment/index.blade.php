...
<div class="content-center pb-5 pl-5 mt-6 ml-18 container-xl">
    <span class="mt-2 mb-6 text-2xl font-bold tracking-wider text-gray-700 uppercase">Establishment TABLE</span>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">Mesa Restaurant
                    </div>
                    </td>
