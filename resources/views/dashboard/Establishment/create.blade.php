...
<div class="container pt-12 mt-5 text-left border-8 rounded-md shadow-md pl-52" >
    <label class="block">
        <span class="text-lg font-bold uppercase ml-14 ">Add Nearby Establishment</span>
      </label>
  ...
  <div class="mt-4">
    <span class="font-bold text-gray-700">Distance</span>
    <input class="block w-3/5 mt-1 form-input" placeholder="Distance.." />
  </div>
