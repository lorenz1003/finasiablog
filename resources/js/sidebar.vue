<template>
    <div class="flex flex-no-wrap bg-gray-200">
        ...
        <div class="absolute flex-col justify-between hidden w-64 bg-indigo-900 shadow sm:relative md:h-full sm:flex">
            <div>
                ...
                <ul class="mt-12">
                    <li class="flex items-center justify-between w-full px-8 py-3 text-gray-600 cursor-pointer hover:text-gray-300 hover:bg-indigo-800">
                ...
                <div class="flex items-center px-8 mt-48 mb-4">
                    <div class="w-10 h-10 mr-3 bg-cover rounded-md">
                        <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_5.png" alt="" class="w-full h-full overflow-hidden rounded-full shadow" />
                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-600">Steve Doe</p>
        ...
        <div class="absolute z-40 flex-col justify-between w-64 transition duration-150 ease-in-out bg-indigo-900 shadow sm:relative md:h-full sm:hidden" id="mobile-nav">
            <div id="openSideBar" class="absolute right-0 flex items-center justify-center w-10 h-10 mt-16 -mr-10 bg-indigo-900 rounded-tr rounded-br shadow cursor-pointer" @click="sidebarHandler(true)">
            ...
            <div id="closeSideBar" class="absolute right-0 items-center justify-center hidden w-10 h-10 mt-16 -mr-10 text-white bg-indigo-900 rounded-tr rounded-br shadow cursor-pointer" @click="sidebarHandler(false)">
